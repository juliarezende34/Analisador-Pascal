...
def uno(lista, gerador):
    if lista[0][0] == dicionario_tokens['+']:
        ...
        temp = gerador.gera_temp()
        gerador.gera_operacao('NEG', temp, op, None)
        return temp
