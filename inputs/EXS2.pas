...
begin;
 ...
 //porem a nota do exame, que é a nota que o usuario precisa tirar, se pega a media que ele precisa tirar para passar
 //que no caso é 6 e, subtrai pela media dele das notas que ele tirou.
  ...
  if (media<=10) and (media >=7)
    then  begin
          writeln ('voce foi aprovado');
                 ...
                 then  begin
                       writeln ('voce ainda pode ser aprovado');
                       end;

                       else if (media <3) and (media >=  1)
                              then begin
                                   writeln (' lamento meu caro mas voce foi reprovado estude mais para a proxima.');
                                   end;
