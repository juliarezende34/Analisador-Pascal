...
//se declara as variaveis todas do tipo inteiro porque no existe ano ou mes ou dia negativo, ou com virgula.

begin;

 //ento voc resume o que o programa faz para o usuario.
 ...
 //entao se inicia a cadeia de ifs onde voc, ira comear pelos anos colocando como condiao um maior que o outro
 //ai caso a primeira condio de um ano ser maior que o outro no for atendida se parte para a segunda.
 //e se caso a segunda no for atendida que seria o caso de anos iguais se parte para os meses.
 //ai se cria uma cadeia para os meses igual a cadeia dos anos, e se caso eles forem iguais se cria uma pros dias tambem.
 //caso os dias forem iguais se manda uma mensagem pro usuario falando que as duas datas so iguais.
